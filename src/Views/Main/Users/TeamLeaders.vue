...
export default {
	...
	computed: {
		...
		...mapGetters("Users", ["getdata", "getTeamLeadersData", "getTeamsData"]),

	},
	methods: {
		...mapActions("Roles", ["GetAdminPermissions", "UpdateUserPermission"]),
		...mapActions("Users", ["GetTeamLeaders", "CreateTeamLeader", "UpdateTeamLeader", "DeleteTeamLeader", "GetTeams"]),
		...
		createFunc() {
			if (this.checkAddValidation()) {
				...
				this.CreateTeamLeader(this.data).then(Response => {
					...
					loading.close();
					this.GetTeamLeaders(this.dataSearch);
		...
		UpdateFunc() {
			if (this.checkUpdateValidation()) {
				...
				this.UpdateTeamLeader(this.data).then(Response => {
		...
		checkUpdateValidation() {
			if (this.data.id == 0) {
				this.$moshaToast('خطأ في تحديد مدير الفريق', {
					hideProgressBar: 'false',
					position: 'top-center',
					showIcon: 'true',
					swipeClose: 'true',
...
<template>
	...
	<div class="page-header">
		<div class="row">
			<div class="col-sm-12">
				<h3 class="page-title">إدارة مدراء الفرق</h3>
				<!-- <ul class="breadcrumb">
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="datatable table table-hover table-center mb-0">
							...
							<tbody>
								<tr v-for="(item, index) in getTeamLeadersData">
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">إضافة مدير فريق جديد</h5>
	...
	<div class="modal fade" id="edit_modal" aria-hidden="true" role="dialog">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">تعديل مدير الفريق</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
