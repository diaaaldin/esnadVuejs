...
export default {
    ...
    computed: {
        ...mapGetters("Reports", ["getFundersReportData"]),
        
        reportData() {
            return this.getFundersReportData || [];
        },
    ...
    methods: {
        ...mapActions("Reports", ["GetFundersReport"]),
...
<template>
    <div id="fundersReport" class="report-wrapper">
        <!-- Header -->
        ...
        <div class="report-container">
            <div class="table-container">
                <div class="tableHeader">
                    <h3 class="title">{{ reportTitle || 'تقرير الممولين' }}</h3>
                </div>
                ...
                <table class="info-table">
                    ...
                    <tr v-if="reportData.length > 0">
                        ...
                        <td colspan="2"><b>{{ formatCurrency(totalAmount) }}</b></td>
                    </tr>
                </table>
            </div>
        </div>
