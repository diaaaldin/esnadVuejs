...
export default {
    ...
    computed: {
        ...mapGetters("Reports", ["getDestinationsReportData"]),
        
        reportData() {
            return this.getDestinationsReportData || [];
        },
    ...
    methods: {
        ...mapActions("Reports", ["GetDestinationsReport"]),
...
<template>
    <div id="destinationsReport" class="report-wrapper">
        <!-- Header -->
        ...
        <div class="report-container">
            <div class="table-container">
                <div class="tableHeader">
                    <h3 class="title">{{ reportTitle || 'تقرير الوجهات' }}</h3>
                </div>
