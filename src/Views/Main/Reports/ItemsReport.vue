...
export default {
    ...
    mounted() {
        if (this.$route.query.title) {
            ...
            this.itemId = parseInt(this.$route.query.itemId) || 0;
    ...
    computed: {
        ...mapGetters("Reports", ["getItemsReportData"]),
        
        reportData() {
            return this.getItemsReportData || [];
        },
    ...
    methods: {
        ...mapActions("Reports", ["GetItemsReport"]),
...
<template>
    <div id="itemsReport" class="report-wrapper">
        <!-- Header -->
        ...
        <div class="report-container">
            <div class="table-container">
                <div class="tableHeader">
                    <h3 class="title">{{ reportTitle || 'تقرير العناصر' }}</h3>
                </div>
                <div class="pageHeader">
                    <p>تاريخ التقرير: <span><b>({{ getFormattedDate() }})</b></span></p>
                    <p v-if="fromDate || toDate">
                        الفترة: <span><b>({{ fromDate || 'بداية' }} - {{ toDate || 'نهاية' }})</b></span>
                    </p>
                </div>
                <table class="info-table">
                    ...
                    <tr v-if="reportData.length > 0">
                        <td><b>الإجمالي</b></td>
                        <td colspan="3"><b>{{ formatCurrency(totalAmount) }}</b></td>
                    </tr>
                </table>
            </div>
        </div>
