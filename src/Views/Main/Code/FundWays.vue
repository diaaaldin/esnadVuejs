...
export default {
    ...
    methods: {
        ...
        clearData() {
            this.data.id = 0;
            this.data.name = "";
            this.data.parent = ParentEnum.FundWays;
            this.data.parent2 = 0;
            this.data.value = 0;
            this.data.valueSt = "";
        ...
        UpdateFunc() {
            if (this.checkUpdateValidation()) {
                ...
                this.UpdateCode(this.data).then(Response => {
                    ...
                    loading.close();
                    this.GetCodesByParent({ parent1: ParentEnum.FundWays, parent2: 0 });
        ...
        selectItem(id) {
            ...
            if (foundItem) {
                ...
                this.data.parent = foundItem.parent || ParentEnum.FundWays;
...
<template>
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">{{ $t('code_fundWays_title') }}</h3>
                <!-- <ul class="breadcrumb">
