...
export default {
    data() {
        return {
            data: {
                id: 0,
                name: "",
                parent: ParentEnum.Destinations,
                parent2: 0,
                arrangeNum: 0,
                value: 0,
                valueSt: "",
    ...
    methods: {
        ...
        clearData() {
            this.data.id = 0;
            this.data.name = "";
            this.data.parent = ParentEnum.Destinations;
            this.data.parent2 = 0;
            this.data.value = 0;
            this.data.valueSt = "";
        ...
        UpdateFunc() {
            if (this.checkUpdateValidation()) {
                ...
                this.UpdateCode(this.data).then(Response => {
                    ...
                    loading.close();
                    this.GetCodesByParent({ parent1: ParentEnum.Destinations, parent2: 0 });
        ...
        selectItem(id) {
            ...
            if (foundItem) {
                ...
                this.data.parent = foundItem.parent || ParentEnum.Destinations;
...
<template>
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">{{ $t('code_destinations_title') }}</h3>
                <!-- <ul class="breadcrumb">
