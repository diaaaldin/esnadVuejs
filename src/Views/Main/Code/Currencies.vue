...
export default {
    ...
    methods: {
        ...
        clearData() {
            this.data.id = 0;
            this.data.name = "";
            this.data.parent = ParentEnum.Currencies;
            this.data.parent2 = 0;
            this.data.value = 0;
            this.data.valueSt = "";
        ...
        UpdateFunc() {
            if (this.checkUpdateValidation()) {
                ...
                this.UpdateCode(this.data).then(Response => {
                    ...
                    loading.close();
                    this.GetCodesByParent({ parent1: ParentEnum.Currencies, parent2: 0 });
        ...
        selectItem(id) {
            ...
            if (foundItem) {
                ...
                this.data.parent = foundItem.parent || ParentEnum.Currencies;
...
<template>
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">{{ $t('code_currencies_title') }}</h3>
                <!-- <ul class="breadcrumb">
