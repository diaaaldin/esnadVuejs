...
export default {
    ...
    methods: {
        ...
        clearData() {
            ...
            this.data.childId = 0;
            this.data.childName = "";
            this.data.parent = ParentEnum.Items;
            this.data.parent2 = 0;
            this.data.value = 0;
            this.data.valueSt = "";
        ...
        UpdateFunc() {
            if (this.checkUpdateValidation()) {
                ...
                this.UpdateCodeWithChild(this.data).then(Response => {
                    ...
                    loading.close();
                    this.GetCodesByParentWithChild({ parent1: ParentEnum.Items, parent2: 0 });
        ...
        selectItem(id) {
            ...
            if (foundItem) {
                ...
                this.data.parent = foundItem.parent || ParentEnum.Items;
...
<template>
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">{{ $t('code_items_title') }}</h3>
                <!-- <ul class="breadcrumb">
                        ...
                        <table class="datatable table table-hover table-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">نوع الكمية</th>
